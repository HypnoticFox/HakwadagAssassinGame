...
<template>
  <div class="cooldown-card">
    <Timer :size="32" class="cooldown-icon" aria-hidden="true" />
    <h2 class="cooldown-title">
      {{ $t('assignment.cooldown.title') }}
    </h2>
    <p class="cooldown-message">
      {{ $t('assignment.cooldown.message') }}
    </p>
    <p class="cooldown-time" role="timer" aria-live="polite">
      {{ formattedTime }}
    </p>
  </div>
</template>
